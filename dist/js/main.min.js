...
(() => { // webpackBootstrap
  ...
  var __webpack_modules__ = ({
    ...
    758:
      ...
      (() => {
        ...
        if (priceInput2[0]) {
          priceInput2[0].addEventListener('input', function () {
        ...
        if (priceInput2[1]) {
          priceInput2[1].addEventListener('input', function () {
        ...
        function _typeof(obj) {
          ...
          var A = function A(e, t) {
            ...
            I = function I(e) {
              ...
              if (e.params.rewind || e.params.loop)
                for (var _a3 = i - t; _a3 <= r + t; _a3 += 1) {
                  var _t3 = (_a3 % s + s) % s;
                  (_t3 < i || _t3 > r) && $(e, _t3);
                } else
                  for (var _a4 = Math.max(i - t, 0); _a4 <= Math.min(r + t, s - 1); _a4 += 1) _a4 !== i && (_a4 > r || _a4 < i) && $(e, _a4);
            };
          var k = {
              ...
              for (var _i3 = 0; _i3 < m; _i3 += 1) {
                ...
                if (z = 0, p[_i3] && (_r3 = p[_i3]), L && e.grid.updateSlide(_i3, _r3, m, t), !p[_i3] || "none" !== w(_r3, "display")) {
                  if ("auto" === a.slidesPerView) {
                    ...
                    if (_l && (_r3.style.transform = "none"), _o && (_r3.style.webkitTransform = "none"), a.roundLengths) z = e.isHorizontal() ? x(_r3, "width", !0) : x(_r3, "height", !0);
                    else {
                      var _e3 = s(_n2, "width"),
                      ...
                      if (_o2 && "border-box" === _o2) z = _e3 + _i4 + _l2;
                      else {
                        var _r4 = _r3,
                          _s5 = _r4.clientWidth,
                          _n3 = _r4.offsetWidth;
          ...
          function se(e) {
            ...
            if ("object" == _typeof(e) && "length" in e)
              for (var _t24 = 0; _t24 < e.length; _t24 += 1) e[_t24] && i(e[_t24]);
            else i(e);
          ...
          var pe = [function (e) {
            ...
            r("beforeInit", function () {
              ...
              appendSlide: function appendSlide(e) {
                if ("object" == _typeof(e) && "length" in e)
                  for (var _t34 = 0; _t34 < e.length; _t34 += 1) e[_t34] && s.virtual.slides.push(e[_t34]);
              ...
              removeSlide: function removeSlide(e) {
                ...
                var t = s.activeIndex;
                if (Array.isArray(e))
                  for (var _a12 = e.length - 1; _a12 >= 0; _a12 -= 1) s.virtual.slides.splice(e[_a12], 1), s.params.virtual.cache && delete s.virtual.cache[e[_a12]], e[_a12] < t && (t -= 1), t = Math.max(t, 0);
                ...
                if (!_a14) {
                  ...
                  if (_l5 >= t.minTranslate() && (_l5 = t.minTranslate()), _l5 <= t.maxTranslate() && (_l5 = t.maxTranslate()), t.setTransition(0), t.setTranslate(_l5), t.updateProgress(), t.updateActiveIndex(), t.updateSlidesClasses(), (!_o5 && t.isBeginning || !_p2 && t.isEnd) && t.updateSlidesClasses(), t.params.loop && t.loopFix({
                    ...
                    var _s25 = u.length ? u[u.length - 1] : void 0,
                      _a15 = u[0];
                    if (u.push(_e43), _s25 && (_e43.delta > _s25.delta || _e43.direction !== _s25.direction)) u.splice(0);
                    else if (u.length >= 15 && _e43.time - _a15.time < 500 && _a15.delta - _e43.delta >= 1 && _e43.delta <= 6) {
                      var _s26 = m > 0 ? .8 : .2;
            ...
            s({
              ...
              if ("undefined" != typeof window && ("string" == typeof t.params.controller.control || t.params.controller.control instanceof HTMLElement)) {
                ...
                if (_e52 && _e52.swiper) t.controller.control = _e52.swiper;
                else if (_e52) {
              ...
              setTranslate: function setTranslate(e, s) {
                ...
                if (Array.isArray(a))
                  for (var _e53 = 0; _e53 < a.length; _e53 += 1) a[_e53] !== s && a[_e53] instanceof l && o(a[_e53]);
            ...
            var l = function l(e) {
              ...
              c = function c(e, s, a) {
                if (s)
                  for (var _i14 = 0, _r11 = t.slides.length; _i14 < _r11; _i14 += 1) {
            ...
            function c(e) {
              ...
              if (t.params.slidesPerView > 1 && !t.params.centeredSlides && (i = t.params.slidesPerView), t.params.thumbs.multipleActiveThumbs || (i = 1), i = Math.floor(i), s.slides.forEach(function (e) {
                ...
                for (var _e55 = 0; _e55 < i; _e55 += 1) f(s.slidesEl, "[data-swiper-slide-index=\"".concat(t.realIndex + _e55, "\"]")).forEach(function (e) {
                  e.classList.add(r);
                });
              else
                for (var _e56 = 0; _e56 < i; _e56 += 1) s.slides[t.realIndex + _e56] && s.slides[t.realIndex + _e56].classList.add(r);
                ...
                onTouchEnd: function onTouchEnd(e) {
                  ...
                  if (s < -t.minTranslate()) t.slideTo(t.activeIndex);
                    ...
                    if (r.freeMode.momentum) {
                      ...
                      var _f;
                      if (_p3 < t.maxTranslate()) r.freeMode.momentumBounce ? (_p3 + t.maxTranslate() < -_h && (_p3 = t.maxTranslate() - _h), _u3 = t.maxTranslate(), _m2 = !0, c.allowMomentumBounce = !0) : _p3 = t.maxTranslate(), r.loop && r.centeredSlides && (_f = !0);
                      else if (_p3 > t.minTranslate()) r.freeMode.momentumBounce ? (_p3 - t.minTranslate() > _h && (_p3 = t.minTranslate() + _h), _u3 = t.minTranslate(), _m2 = !0, c.allowMomentumBounce = !0) : _p3 = t.minTranslate(), r.loop && r.centeredSlides && (_f = !0);
            ...
            le({
              ...
              setTranslate: function setTranslate() {
                ...
                if (s.style.transformOrigin = "50% 50% -".concat(o / 2, "px"), s.style["-webkit-transform-origin"] = "50% 50% -".concat(o / 2, "px"), c.shadow)
                  if (p) m.style.transform = "translate3d(0px, ".concat(r / 2 + c.shadowOffset, "px, ").concat(-r / 2, "px) rotateX(90deg) rotateZ(0deg) scale(").concat(c.shadowScale, ")");
                  else {
  ...
  (() => {
    ...
    // EXTERNAL MODULE: ./src/js/import/tab.js
    var tab = __webpack_require__(332);
    // EXTERNAL MODULE: ./src/js/import/burger.js
    var burger = __webpack_require__(911);
    // EXTERNAL MODULE: ./src/js/import/list.js
    var list = __webpack_require__(666);
    // EXTERNAL MODULE: ./src/js/import/input.js
    var input = __webpack_require__(758);
    // EXTERNAL MODULE: ./src/js/import/swiper.js
    var swiper = __webpack_require__(30);
    var swiper_default = /*#__PURE__*/ __webpack_require__.n(swiper);; // CONCATENATED MODULE: ./src/js/import/slider.js

    var slider_swiper = new(swiper_default())('.swiper', {
      // Optional parameters
      direction: 'horizontal',
      loop: true,
      spaceBetween: 20,
    ...
    var swiper1 = new(swiper_default())('.swiper1', {
      // Optional parameters
      direction: 'horizontal',
      spaceBetween: 20,
      loop: true,
    ...
    var swiper3 = new(swiper_default())(".mySwiper", {
      loop: true,
      spaceBetween: 9,
      slidesPerView: 2,
      freeMode: true,
    ...
    var swiper2 = new(swiper_default())(".mySwiper2", {
      loop: true,
      spaceBetween: 20,
      thumbs: {
        swiper: swiper3
    ...
    var swiper4 = new(swiper_default())('.swiper4', {
      // Optional parameters
      direction: 'horizontal',
      loop: true,
      spaceBetween: 20,
    ...
    var swiper5 = new(swiper_default())('.swiper5', {
      direction: 'horizontal',
      spaceBetween: 20,
      slidesPerView: 2,
      pagination: {
    ...
    var swiper6 = new(swiper_default())('.swiper6', {
      direction: 'horizontal',
      loop: true,
      spaceBetween: 20,
      pagination: {
    ...
    // EXTERNAL MODULE: ./src/js/import/showSettings.js
    var showSettings = __webpack_require__(853);
    // EXTERNAL MODULE: ./src/js/import/showImage.js
    var showImage = __webpack_require__(485);
    // EXTERNAL MODULE: ./src/js/import/fullComplect.js
    var fullComplect = __webpack_require__(933);
    // EXTERNAL MODULE: ./src/js/import/dynamicAdapt.js
    var dynamicAdapt = __webpack_require__(761);
    // EXTERNAL MODULE: ./src/js/import/showFeedback.js
    var showFeedback = __webpack_require__(951);
    // EXTERNAL MODULE: ./src/js/import/calculator.js
    var calculator = __webpack_require__(606);
    // EXTERNAL MODULE: ./src/js/import/showMore.js
    var showMore = __webpack_require__(823);; // CONCATENATED MODULE: ./src/js/index.js
