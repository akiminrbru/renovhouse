...
var plan1 = document.querySelector(".modal-photo1");
var plan2 = document.querySelector(".modal-photo2");
var btnPlan1 = document.querySelector(".projectsDetailPlan__photo-btn1");
var btnPlan2 = document.querySelector(".projectsDetailPlan__photo-btn2");
var btnClose1 = document.querySelector(".modal-photo-close1");
var btnClose2 = document.querySelector(".modal-photo-close2");
if (btnPlan1) {
