...
var burger__content = document.querySelector(".burger__content");
var open = document.querySelector(".header__burgerOpen");
var close = document.querySelector(".header__burgerClose");
...
burger__content.addEventListener('click', function (e) {
  e.stopPropagation();
});

/***/ }),

/***/ "./src/js/import/calculator.js":
/*!*************************************!*\
  !*** ./src/js/import/calculator.js ***!
  \*************************************/
/***/ (() => {
  ...
  var _loop6 = function _loop6(_i14) {
    step3_floor2_Cards[_i14].addEventListener("click", function () {
      ...
      for (var j = 0; j < step3_floor2_Cards.length; j++) {
        step3_floor2_Cards[j].classList.remove("step3_lap_floor1_active");
        step3_floor2_Cards[j].lastElementChild.classList.remove("calculator__selecters_active");
      }
      step3_floor2_Cards[_i14].classList.add("step3_lap_floor1_active");
...
step1_floorsInputs[0].addEventListener('change', function (e) {
  ...
  // Step 2 (floor2) clear
  var step2_clear = document.querySelector('.step2_wall_floor2_active');
...
/***/ "./src/js/import/calculatorLogic.js":
/*!******************************************!*\
  !*** ./src/js/import/calculatorLogic.js ***!
  \******************************************/
/***/ (() => {
...
// console.log(step1_square.innerHTMl)

// step1_width.addEventListener('input', () => [
//     console.log(step1_width.value * step1_length.value)
...
/***/ "./src/js/import/fullComplect.js":
/*!***************************************!*\
  !*** ./src/js/import/fullComplect.js ***!
  \***************************************/
/***/ (() => {

var btnDown = document.querySelector(".projectsDetailComplect__btnDown");
var btnUp = document.querySelector(".projectsDetailComplect__btnUp");
var complectBlock = document.querySelector(".projectsDetailComplect__tableComplect");
if (btnDown) {
...
function getVals() {
  var slides = document.getElementsByClassName("rangeInput");
  ...
  var displayElement = document.getElementsByClassName("projectsTop__rangeValues")[0];
  displayElement.innerHTML = "$ " + slide1 + "k - $" + slide2 + "k";
}
window.onload = function () {
  // Initialize Sliders
  var sliderSections = document.getElementsByClassName("projectsTop__range-slider");
...
var priceGap2 = 0;
priceInput2.forEach(function (input) {
  input.addEventListener("input", function (e) {
    var minPrice2 = parseInt(priceInput2[0].value),
...
rangeInput2.forEach(function (input) {
  input.addEventListener("input", function (e) {
    var minVal2 = parseInt(rangeInput2[0].value),
...
var checkList = document.getElementsByClassName('projectsTop__checkbox');
var resetBtn = document.querySelector('.projectsTop__reset-btn');
if (resetBtn) {
...
/***/ "./src/js/import/list.js":
/*!*******************************!*\
  !*** ./src/js/import/list.js ***!
  \*******************************/
/***/ (() => {

var acc = document.getElementsByClassName("help__card");
if (acc) {
...
var advantageBtn = document.querySelector('.advantage__btn');
if (mainBtn) {
...
/***/ "./src/js/import/showImage.js":
/*!************************************!*\
  !*** ./src/js/import/showImage.js ***!
  \************************************/
/***/ (() => {

var galleryItem = document.getElementsByClassName("projectsDetailPlan__photo");
var lightBoxContainer = document.createElement("div");
var lightBoxContainerFlex = document.createElement("div");
...
window.onload = function () {
  var box = document.querySelectorAll('.projects__card');
  var btn = document.querySelector('.projects__button');
  for (var i = 6; i < box.length; i++) {
  ...
  if (btn) {
    btn.addEventListener("click", function () {
      ...
      if (countD <= box.length) {
        for (var _i = 0; _i < countD; _i++) {
          box[_i].classList.remove('projects__hide');
        }
      }
      if (countD >= box.length) {
  ...
  var portfolioCard = document.querySelectorAll('.portfolioPageMain__card');
  var portfiolBtn = document.querySelector('.portfolioPageMain__button');
  for (var _i2 = 5; _i2 < portfolioCard.length; _i2++) {
    portfolioCard[_i2].classList.add('portfolioPageMain__hide');
  }
  var countDPortfolio = 5;
  if (portfiolBtn) {
    portfiolBtn.addEventListener("click", function () {
      countDPortfolio += 2;
      if (countDPortfolio <= portfolioCard.length) {
        for (var _i3 = 0; _i3 < countDPortfolio; _i3++) {
          portfolioCard[_i3].classList.remove('portfolioPageMain__hide');
        }
      }
      if (countDPortfolio >= portfolioCard.length) {
...
var portfolioCards = document.querySelectorAll(".portfolioPageMain__card");
var indexCard = portfolioCards.length - 1;
...
/***/ "./src/js/import/showSettings.js":
/*!***************************************!*\
  !*** ./src/js/import/showSettings.js ***!
  \***************************************/
/***/ (() => {

var btnSettings = document.querySelector('.projectsTop__settings-btn');
var closeBtnSettings = document.querySelector('.projectsTop__close');
var confirmBtn = document.querySelector('.projectsTop__confirm');
var blockSettingsWrapper = document.querySelector('.projectsTop__settings-wrapper');
var blockSettings = document.querySelector('.projectsTop__settings');
var blockSettingsContent = document.querySelector('.projectsTop__settings-content');
var blockSettingTitle = document.querySelector('.projectsTop__title-mobile');
if (btnSettings) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./swiper */ "./src/js/import/swiper.js");
...
var swiper = new (_swiper__WEBPACK_IMPORTED_MODULE_0___default())('.swiper', {
  // Optional parameters
...
var swiper1 = new (_swiper__WEBPACK_IMPORTED_MODULE_0___default())('.swiper1', {
  // Optional parameters
  direction: 'horizontal',
  spaceBetween: 20,
  loop: true,
...
var _loop = function _loop(i) {
  bullet[i].addEventListener('mouseover', function () {
    bullet[i].click();
  });
  bullet[i].addEventListener('mousedown', function () {
...
var swiper3 = new (_swiper__WEBPACK_IMPORTED_MODULE_0___default())(".mySwiper", {
  loop: true,
  spaceBetween: 9,
  slidesPerView: 2,
  freeMode: true,
...
var swiper2 = new (_swiper__WEBPACK_IMPORTED_MODULE_0___default())(".mySwiper2", {
  loop: true,
  spaceBetween: 20,
  thumbs: {
    swiper: swiper3
...
var swiper4 = new (_swiper__WEBPACK_IMPORTED_MODULE_0___default())('.swiper4', {
  // Optional parameters
  direction: 'horizontal',
  loop: true,
  spaceBetween: 20,
...
var swiperPrev4 = document.getElementById("swiper-next4");
var swiperNext4 = document.getElementById("swiper-prev4");
if (swiperPrev4 && swiperNext4) {
  swiperPrev4.addEventListener("click", function () {
    swiper4.slidePrev();
  });
  swiperNext4.addEventListener("click", function () {
    swiper4.slideNext();
  });
}
var swiper5 = new (_swiper__WEBPACK_IMPORTED_MODULE_0___default())('.swiper5', {
  direction: 'horizontal',
  loop: true,
  spaceBetween: 20,
  slidesPerView: 2,
...
var swiper6 = new (_swiper__WEBPACK_IMPORTED_MODULE_0___default())('.swiper6', {
  direction: 'horizontal',
  loop: true,
  spaceBetween: 20,
  pagination: {
...
var swiperPrev6 = document.getElementById("swiper-next6");
var swiperNext6 = document.getElementById("swiper-prev6");
if (swiperPrev6 && swiperNext6) {
  swiperPrev6.addEventListener("click", function () {
    swiper6.slidePrev();
  });
  swiperNext6.addEventListener("click", function () {
    swiper6.slideNext();
  });
}
...
/***/ "./src/js/import/tab.js":
/*!******************************!*\
  !*** ./src/js/import/tab.js ***!
  \******************************/
/***/ (() => {

var btn1 = document.getElementById("radio-1");
var btn2 = document.getElementById("radio-2");
var tab1 = document.querySelector('.gallery__images1');
var tab2 = document.querySelector('.gallery__images2');
var input = document.querySelectorAll('.gallery__input');
...
for (var _i = 0; _i < tabNavs.length; _i++) {
  tabNavs[_i].addEventListener("click", function (e) {
    e.preventDefault();
...
var btn1_2 = document.getElementById("radio-1_2");
var btn2_2 = document.getElementById("radio-2_2");
var tab1_2 = document.querySelector('.projectsDetailPlan__desc-list1');
var tab2_2 = document.querySelector('.projectsDetailPlan__desc-list2');
var input_2 = document.querySelectorAll('.projectsDetailPlan__input');
for (var _i2 = 0; _i2 < input_2.length; _i2++) {
  input_2[_i2].addEventListener('change', function () {
    if (btn1_2.checked) {
...
var btn1_3 = document.getElementById("radio-1_3");
var btn2_3 = document.getElementById("radio-2_3");
var tab1_3 = document.querySelector('.projectsDetailDesc__desc');
var tab2_3 = document.querySelector('.projectsDetailDesc__charact');
var input_3 = document.querySelectorAll('.projectsDetailDesc__input');
for (var _i3 = 0; _i3 < input_3.length; _i3++) {
  input_3[_i3].addEventListener('change', function () {
    if (btn1_3.checked) {
...
var writenext = document.querySelector('.projectsDetailDesc__write-next');
var writeback = document.querySelector('.projectsDetailDesc__write-back');
var textDesc = document.querySelector('.projectsDetailDesc__hidden');
if (writenext) {
  writenext.addEventListener('click', function () {
...
/* harmony import */ var _import_tab__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./import/tab */ "./src/js/import/tab.js");
/* harmony import */ var _import_tab__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_import_tab__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _import_burger__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./import/burger */ "./src/js/import/burger.js");
/* harmony import */ var _import_burger__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_import_burger__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _import_list__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./import/list */ "./src/js/import/list.js");
/* harmony import */ var _import_list__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_import_list__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _import_input__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./import/input */ "./src/js/import/input.js");
/* harmony import */ var _import_input__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_import_input__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _import_slider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./import/slider */ "./src/js/import/slider.js");
/* harmony import */ var _import_showSettings__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./import/showSettings */ "./src/js/import/showSettings.js");
/* harmony import */ var _import_showSettings__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_import_showSettings__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _import_showImage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./import/showImage */ "./src/js/import/showImage.js");
/* harmony import */ var _import_showImage__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_import_showImage__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _import_fullComplect__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./import/fullComplect */ "./src/js/import/fullComplect.js");
/* harmony import */ var _import_fullComplect__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_import_fullComplect__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _import_dynamicAdapt__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./import/dynamicAdapt */ "./src/js/import/dynamicAdapt.js");
/* harmony import */ var _import_dynamicAdapt__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_import_dynamicAdapt__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _import_showFeedback__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./import/showFeedback */ "./src/js/import/showFeedback.js");
/* harmony import */ var _import_showFeedback__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_import_showFeedback__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _import_calculatorLogic__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./import/calculatorLogic */ "./src/js/import/calculatorLogic.js");
/* harmony import */ var _import_calculatorLogic__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_import_calculatorLogic__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _import_calculator__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./import/calculator */ "./src/js/import/calculator.js");
/* harmony import */ var _import_calculator__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_import_calculator__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _import_showMore__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./import/showMore */ "./src/js/import/showMore.js");
/* harmony import */ var _import_showMore__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_import_showMore__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var _import_swiper__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./import/swiper */ "./src/js/import/swiper.js");
/* harmony import */ var _import_swiper__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_import_swiper__WEBPACK_IMPORTED_MODULE_15__);
